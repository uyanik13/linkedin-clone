  ...
  <div class="flex flex-row justify-center ">
    <div class="bg-white my-2 pb-6 w-full justify-center items-center overflow-hidden md:max-w-sm rounded-lg shadow-sm mx-auto ">
      ...
      <div class="relative shadow mx-auto h-16 w-16 -my-12 rounded-full  overflow-hidden border-4 border-white ">
        <img class="object-cover w-full h-full" src="https://media-exp1.licdn.com/dms/image/C4E35AQHYiObqT_uAOA/profile-framedphoto-shrink_100_100/0/1608036315334?e=1608728400&v=beta&t=ZFoJftkUVLoAdGOHeTAxTCFx2KYOXwRX3zZUT7GBvJQ">
      </div>
      <div class="mt-16 border-b-default border-gray-300">
        <h1 class="text-lg text-center text-primary ">
         Oğur UYANIK
        </h1>
        <p class="text-sm text-secondary text-center pb-4">
          Full Stack Developer
        </p>
      </div>
      <div class="mt-3 text-3 pt-1 px-3 hover:bg-theme1 flex mt-0 px-2  items-center justify-between">
      ...
      <div class="mt-3 text-4 pt-1 px-3 hover:bg-theme1 flex mt-0 px-2  items-center justify-between border-t-default border-gray-300">
          <div class="text-gray-600 px-0">
             <font-awesome-icon :icon="['fas', 'bookmark']" class="text-3"  />
            My items
          </div>
      </div>
    </div>
